...
public class RegistrationTest {
	...
	public void performTest() throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@type='email']")).sendKeys("Ritesh@gmail.com");
		driver.findElement(By.xpath("//input[@type='password']")).sendKeys("Ritesh@123");
		...
		driver.findElement(By.cssSelector(".form-group:nth-child(5) > .ng-untouched")).sendKeys("Lohia Colony");
		driver.findElement(By.cssSelector(".form-group:nth-child(6) > .ng-untouched")).sendKeys("9089761234");
		driver.findElement(By.xpath("//div[7]/input")).sendKeys("23/06/1984");
